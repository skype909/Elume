...
export default function StudentJoinQuizPage() {
  ...
  const answersOpen = current?.answers_open !== false;
                ...
                <>
                  <div className="rounded-[28px] border border-cyan-100 bg-gradient-to-br from-cyan-50 via-white to-emerald-50 p-4 shadow-sm sm:p-5">
                    ...
                    {hasAnswered && selectedChoice ? (
                      ...
                      <div className="mt-4 text-sm font-semibold text-slate-600">
                        {answersOpen ? "Tap an option below to submit your answer." : "Time is up for this question."}
                      </div>
                    )}
                  </div>
                  ...
                  <div className="mt-4 grid grid-cols-1 gap-3">
                    {displayOrder.map((k, idx) => {
                      ...
                      const disabled = !label.trim() || !answersOpen || answersLocked;
                  ...
                  <div className="mt-4 text-center text-xs text-slate-600">
                    {answersOpen ? "Tip: You can change your answer until the teacher moves on." : "The teacher will move on shortly."}
                  </div>
                </>
              )}
            </div>
