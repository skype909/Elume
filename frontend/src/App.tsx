        ...
        <div className="mx-auto flex max-w-7xl items-center px-4 py-6">
          ...
          <div className="flex items-center gap-5">
            ...
            <div className="leading-tight">
              <div className="hidden md:block text-5xl font-black tracking-tight leading-none">
                <div
                  className="hidden md:block text-5xl font-extrabold tracking-tight text-slate-700"
